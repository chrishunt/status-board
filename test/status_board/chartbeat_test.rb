    ...
    describe '#summary' do
      it 'returns a table summary of current visitors as html' do
        VCR.use_cassette('chartbeat/summary') do
          ...
          assert_equal "<table><tr><td style='width:40px'><img src='/browsers/chrome.png'></td><td style='width:40px'><img src='/flags/gb.png'></td><td style='width:40px'>A1</td><td>Example Site Podcast</td></tr><tr><td style='width:40px'><img src='/browsers/chrome.png'></td><td style='width:40px'><img src='/flags/ca.png'></td><td style='width:40px'>AB</td><td>1: Why I use Vim</td></tr><tr><td style='width:40px'><img src='/browsers/firefox.png'></td><td style='width:40px'><img src='/flags/us.png'></td><td style='width:40px'>VA</td><td>1: Why I use Vim</td></tr></table>",
          chartbeat.summary
        end
      end
    end
